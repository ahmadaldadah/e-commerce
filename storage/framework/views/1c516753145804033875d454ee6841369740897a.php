        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            ...
            <div class="form-inline my-2 my-lg-0">
                <input id="search" class="form-control mr-sm-2 ml-15"
                    ...
                    <span class="badge badge-light bg-secondary"><?php echo e(Auth::user()->products()->sum('count')); ?></span>
                    <?php endif; ?>
                </a>
                <?php if(auth()->guard()->guest()): ?>
...
<?php /**PATH C:\Users\sadi-\Desktop\maba 2019-9-12\resources\views/layouts/app.blade.php ENDPATH**/ ?>